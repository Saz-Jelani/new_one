...
@section('title','Best Ecommerce Website in BD')
...
@section('body')
    ...
    <!-- Home Section Start -->
    <section class="home-section-2 home-section-big section-b-space">
        <div class="container-fluid-lg">
            <div class="row g-4">
                <div class="col-xl-8 ratio_65">
                    <div class="home-contain h-100">
                        <div class="h-100">
                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/1.jpg" class="bg-img blur-up lazyload" alt="">
                        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/2.jpg" class="bg-img blur-up lazyload"
                                     alt="">
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/3.jpg" class="bg-img blur-up lazyload"
                                     alt="">
                                <div class="home-detail p-center-left home-p-sm w-75">
                                    <div>
            ...
            <div class="banner-slider">
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/4.jpg" class="bg-img blur-up lazyload" alt="">
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/5.jpg" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/6.jpg" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/7.jpg" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                                <h5>Buy More & Save More</h5>
                    ...
                    <div class="p-sticky">
                        ...
                        <div class="ratio_156 section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/8.jpg" class="bg-img blur-up lazyload"
                                     alt="">
                        ...
                        <div class="ratio_medium section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/11.jpg" class="img-fluid blur-up lazyload"
                                     alt="">
                                <div class="home-detail p-top-left home-p-medium">
                                    <div>
                                        ...
                                        <div class="offer-product">
                                            ...
                                            <div class="offer-detail">
                                                <div>
                                                    ...
                                                    <span>450 Gm</span>
                                                    <h6 class="price theme-color">{{$product->selling_price}}Tk</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                ...
                <div class="col-xxl-9 col-xl-8">
                                            ...
                                            <div class="product-box">
                                                ...
                                                <div class="product-detail">
                                                    ...
                                                    <h5 class="sold text-content">
                                                        <span class="theme-color price">{{$product->selling_price}}Tk</span>
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/9.jpg" class="bg-img blur-up lazyload"
                                         alt="">
                            ...
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/10.jpg" class="bg-img blur-up lazyload"
                                         alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                                            <h3 class="text-exo">50% offer</h3>
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-xxl-8 col-xl-12 col-md-7">
                                <div class="banner-contain hover-effect">
                                    <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/12.jpg" class="bg-img blur-up lazyload"
                                         alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/11.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/12.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/13.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/14.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/15.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/16.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/17.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/18.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/19.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/20.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/21.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/product/22.png"
                                                 class="blur-up lazyload" alt="">
                                        </a>
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain hover-effect">
                            <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/banner/14.jpg" class="bg-img blur-up lazyload" alt="">
                    ...
                    <!-- <div class="slider-3-blog ratio_65 no-arrow product-wrapper">
                            ...
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/blog/1.jpg" class="bg-img blur-up lazyload"
                                             alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/blog/2.jpg" class="bg-img blur-up lazyload"
                                             alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{asset('/')}}front-end-assets/assets/images/vegetable/blog/3.jpg" class="bg-img blur-up lazyload"
                                             alt="">
                                    </a>
                                </div>
