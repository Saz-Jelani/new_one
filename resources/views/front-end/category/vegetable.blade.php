...
@section('title','product Category vegetable page')
...
@section('body')
    ...
    <div class="container-fluid-lg">
        <div class="row">
            ...
            <div class="category-slider-2 no-arrow">
                <div>
                    <a href="{{route('product-category-vegetable&fruits')}}" class="category-box category-dark">
                        <div>
                ...
                <div>
                    <a href="{{route('product-category-beverages')}}" class="category-box category-dark">
                        <div>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-daley="0.25s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{asset('/')}}front-end-assets/assets/images/cake/product/7.png"
                                                 class="img-fluid blur-up lazyload" alt="">
                                        </a>
