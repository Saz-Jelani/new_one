                                        ...
                                        <form class="form-horizontal" action="{{route('brand.update', ['id' => $brand->id])}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="theme-form theme-form-2 mega-form">
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" id="firstname" type="text" value="{{$brand->name}}"
                                                ...
                                                <div class="theme-form theme-form-2 mega-form">
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <label class="switch">
                                                               <input type="hidden" name="status" {{$brand->status == 0 ? 'checked' : ''}} value="0"> <span class="switch-state"></span>
                                                                <input type="checkbox" name="status" {{$brand->status == 1 ? 'checked' : ''}} value="1"> <span class="switch-state"></span>
