                                        ...
                                        <form class="form-horizontal" action="{{route('unit.update', ['id' => $unit->id])}}" method="POST" >
                                            ...
                                            <div class="theme-form theme-form-2 mega-form">
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" id="firstname" type="text" value="{{$unit->name}}"
                                                ...
                                                <div class="theme-form theme-form-2 mega-form">
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input class="form-control" id="" type="text"  value="{{$unit->code}}"
                                                ...
                                                <div class="theme-form theme-form-2 mega-form">
                                                    ...
                                                    <textarea class="form-control" id="firstname"
                                                              placeholder="Unit Description" name="description"> {{$unit->description}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <label class="switch">
                                                                <input type="hidden" name="status" {{$unit->status == 0 ? 'checked' : ''}} value="0"> <span class="switch-state"></span>
                                                                <input type="checkbox" name="status" {{$unit->status == 1 ? 'checked' : ''}} value="1"> <span class="switch-state"></span>
